...
//            post.setHeader("Content-Type", "application/json");
//        }
//        post.addHeader("Content-Length","41504");
//      //  post.addHeader("Authorization", "Basic " + Base64.getUrlEncoder().encodeToString(("HAIN460000" + ":" + "topicis123").getBytes()));
////        post.addHeader("Authorization", "Basic YWRtaW46");
...
//        try {
////            StringEntity s = new StringEntity(Info.toString(), "utf-8");
////            s.setContentEncoding("gzip, deflate, br");
////            post.setEntity(s);
//            //文件上传
//            //TODO 文件上传
//            MultipartEntity muit = new MultipartEntity();
//            FileBody fileBody = new FileBody(file);
//            muit.addPart(fileName, fileBody);
//
//            post.setEntity(muit);
//            // 发送请求
//            HttpResponse httpResponse = client.execute(post);
...
//            }
//        } catch (Exception e) {
//            System.out.println("请求异常"+ ExceptionUtil.stacktraceToString(e));
//           return null;
//        }
//
//        return JSONObject.parseObject(result);
